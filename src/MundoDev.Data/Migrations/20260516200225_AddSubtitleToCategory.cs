    ...
    public partial class AddSubtitleToCategory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_E_Plans", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_P_OrderStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartLicense = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndLicense = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_E_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_E_Orders_E_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "E_Plans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_E_Orders_E_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "E_Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_E_Orders_P_OrderStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "P_OrderStatuses",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionId = table.Column<string>(type: "varchar(200)", nullable: true),
                    Gateway = table.Column<string>(type: "varchar(100)", nullable: true),
                    PaidDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_E_Payments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_E_Payments_E_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "E_Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_E_Payments_E_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "E_Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_E_Orders_PlanId",
                table: "E_Orders",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_E_Orders_StatusId",
                table: "E_Orders",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_E_Orders_UserId",
                table: "E_Orders",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_E_Payments_OrderId",
                table: "E_Payments",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_E_Payments_UserId",
                table: "E_Payments",
                column: "UserId");
