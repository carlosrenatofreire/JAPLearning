...
{
    public class ModuleService : AuditableService<Module, IModuleRepository>, IModuleService
    {
        ...
        public override async Task<bool> AddAsync(Module entity)
        {
            if (!await ValidateAsync(new ModuleValidation(), entity)) return false;
